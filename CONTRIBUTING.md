# Contributing to @remotex-labs/xmap

Thank you for your interest in contributing! Every bug report, documentation fix, and feature addition makes xmap better for everyone.
...
Click the **Fork** button at the top right of the [xMap repository](https://github.com/remotex-labs/xMap) on GitHub. This creates a copy of the repo under your own account.
...
```bash
git remote -v
# origin    https://github.com/<your-username>/xMap.git (fetch)
# origin    https://github.com/<your-username>/xMap.git (push)
# upstream  https://github.com/remotex-labs/xMap.git (fetch)
# upstream  https://github.com/remotex-labs/xMap.git (push)
```
...
2. Make sure the base is set to `remotex-labs/xMap` → `master`
...
xmap ships a tree-shakeable ESM build.
